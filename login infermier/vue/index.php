...
$(document).ready(function(){
  ...
  $("#submit").click(function(){
    ...
    function(data,status){
    	alert(data);
      if (data=="success") {
        $(location).attr("href","espace_infermerie/conindex.php");
...
<div class="w3layouts-main"> 
	<div class="bg-layer">
		...
		<!-- copyright -->
		<div class="copyright">
			<p>Urgence:  <a href="http://w3layouts.com/" target="_blank">Espace infirmière</a></p>
		</div>
		<!-- //copyright --> 
	</div>
</div>	
