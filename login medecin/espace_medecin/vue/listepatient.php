        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
             ...
             <li><a href="conlistepatientservie.php">Liste patient servie</a></li>
            </ul>
          </li>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>Liste des patient</h4>
                <hr>
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-bookmark"></i>Degré de gravité</th>
          ...
          <tr data-expanded="true">
            ...
            <td><?php echo  $me['degre_gravite'] ;  ?></td>
                    ...
                    <td>
                      ...
                      <button class="btn btn-danger btn-xs" onclick="serviepatient(<?php echo  $me['id_patient'] ;  ?>)">Servie</button>
                    </td>
                  </tr>
                  <?php  endforeach ;    ?>
                </tbody>
