...
<body>
          ...
          <div class="col-md-12">
            <div class="content-panel">
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i>Liste des medecins</h4>
                <hr>
                <thead>
                  <tr>
           ...
           <td><?php echo  $me['nom'] ;  ?></td>
            ...
            <td><?php echo  $me['mp'] ;  ?></td>
                   ...
                   <td>
                      ...
                      <button class="btn btn-primary btn-xs" onclick="getmedecin(<?php echo  $me['id_medecin'] ;  ?>)">Modifier</button>
                      <button class="btn btn-danger btn-xs" onclick="suppmedecin(<?php echo  $me['id_medecin'] ;  ?>)">Supprimer</button>
                    </td>
                  </tr>
                  <?php  endforeach ;    ?>
                </tbody>
  ...
  <script src="lib/zabuto_calendar.js"></script>
   ...
   <!--modal modofier medecin-->
  <div class="modal fade" id="modifiermedecin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modifier medecin</h5>
      ...
      <form class="cmxform form-horizontal style-form" >
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="uppnom" name="firstname" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Prénom</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="uprenom" name="lastname" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Grade</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="uppgrade" name="lastname" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="username" class="control-label col-lg-2">Numero de cin</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="uppcin" name="username" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="email" class="control-label col-lg-2">Email</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="uppmail" name="email" type="email" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="password" class="control-label col-lg-2">Mot de passe</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="uppmd" name="password" type="password" />
                    </div>
                  </div>
                     ...
                     <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <input type="hidden" id="id_medecin_hidden">  
                                            <button class="btn btn-primary" type="button" onclick="modifiermedecin()">enregister modification</button>
